//  la documentacion de esta clase esta aqui
//  https://platzi.com/clases/3175-asincronismo-js/50093-xmlhttprequest/
...
function fetchData(urlApi, callback) {
    ...
    xhttp.onreadystatechange = function (evento) {ç
...
fetchData(`${API}/products`, function (error1, datos1) {
    ...
    fetchData(`${API}/products/${datos1[0].id}`, function (error2, datos2) {
        ...
        fetchData(`${API}/categories/${datos2.category.id}`, function (error3, datos3) {
